...
export type Contact = { id: string; full_name: string; email: string; company: string; status: ContactStatus; source: ContactSource; phone: string | null; notes: string | null; created_at: string; updated_at: string };
